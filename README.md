...
```bash
pipx install tap-dashboard-reports
```
...
```bash
tap-dashboard-reports --version
tap-dashboard-reports --help
tap-dashboard-reports --config CONFIG --discover > ./catalog.json
```
...
meltano elt tap-dashboard-reports target-jsonl
```
